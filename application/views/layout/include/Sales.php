...
?>
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li <?php echo $import?> >
                    <a href="<?php echo base_url()?>customer/import">
                        <i class="pe-7s-note2"></i>
                        <p>Import</p>
                    </a>
                </li>
                <li <?php echo $manual?> >
                    <a href="<?php echo base_url()?>customer/manual">
                        <i class="pe-7s-news-paper"></i>
                        <p>Manual Registration</p>
                    </a>
                </li>
                <li <?php echo $customer?> > 
                    <a href="<?php echo base_url()?>customer/customer_con">
                        <i class="pe-7s-science"></i>
                        <p>view/Edit Customer</p>
                        </a>
                        </li>
                        <li <?php echo $viewlead?> >
                         <a href="<?php echo base_url()?>customer/viewlead">
                        <i class="pe-7s-user"></i>
                        <p>View lead</p>
                    </a>
                </li>
